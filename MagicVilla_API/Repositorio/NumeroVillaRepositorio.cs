...
namespace MagicVilla_API.Repositorio
{
    public class NumeroVillaRepositorio : Repositorio<NumeroVilla>, INumeroVillaRepositorio
    {
        ...
        public NumeroVillaRepositorio(ApplicationDbContext db) : base(db) //El base es debido a que Irepositorio tambien tiene inyectado el 
            //ApplicationDbContext 
        {
            _db = db;
            this.dbSet = _db.Set<NumeroVilla>();
        }
